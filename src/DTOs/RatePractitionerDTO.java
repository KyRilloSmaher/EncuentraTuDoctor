...
/**
 * Data Transfer Object for submitting practitioner ratings.
 * Contains information about a patient's experience with a practitioner,
 * including rating value, waiting time, and comments.
 */
public class RatePractitionerDTO {
    /** Unique identifier of the practitioner being rated */
    ...
    /**
     * Constructs a new RatePractitionerDTO with the specified details.
     *
     * @param practitionerId Unique identifier of the practitioner
     ...
     */
    public RatePractitionerDTO(int practitionerId, int patientId, double rating, 
